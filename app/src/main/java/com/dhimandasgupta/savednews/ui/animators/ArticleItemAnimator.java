package com.dhimandasgupta.savednews.ui.animators;
...
public class ArticleItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateChange(@NonNull final RecyclerView.ViewHolder oldHolder,
                                 @NonNull final RecyclerView.ViewHolder newHolder, @NonNull ItemHolderInfo preInfo,
    ...
    @Override
    public @NonNull ItemHolderInfo recordPreLayoutInformation(@NonNull RecyclerView.State state,
                                                              @NonNull RecyclerView.ViewHolder viewHolder, @AdapterChanges int changeFlags,
    ...
    public interface OnAnimateChangeListener {
        Animator onAnimateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, long duration);
